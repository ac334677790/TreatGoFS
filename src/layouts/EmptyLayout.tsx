      ...
      <header className="bg-stone-800 text-white py-4 shadow-md">
        <div className="container mx-auto flex items-center justify-between px-6">
          ...
          <nav className="flex items-center gap-6">
            <Link to="/" className="text-amber-500 hover:text-yellow-400 transition">首頁</Link>
            <Link to="/about" className="text-amber-500 hover:text-yellow-400 transition">關於我們</Link>
            <Link to="/contact" className="text-amber-500 hover:text-yellow-400 transition">聯絡我們</Link>
          <div>
            <Link to="/signup" className="text-amber-500 hover:text-yellow-400 transition">註冊</Link>
              <span className="mx-1 text-stone-500">|</span>
            <Link to="/login" className="text-amber-500 hover:text-yellow-400 transition">登入</Link>
          </div>
          </nav>
        </div>
      </header>
