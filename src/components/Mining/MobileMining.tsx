  ...
  return (
    <div className="p-4 md:p-8 max-w-xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link
          to="/"
          className="flex items-center justify-between text-xl font-bold text-amber-500"
        >
      ...
      {/* 礦層圖 */}
      <div className="relative bg-stone-900 rounded-xl mb-6" style={{ height: '300px' }}>
        {/* 進度條 */}
      ...
      {/* Word Card */}
      <div className="absolute top-14 word-card bg-stone-800 rounded-xl" style={{ maxWidth: '650px', width:'90%',left:'5%'}}>
        <div className="relative mt-1">
          ...
          <div className="absolute inset-x-0 flex justify-center items-center gap-2">
            ...
            <div className="p-1 text-md font-bold text-amber-500">
            ...
            <h2 className="p-1 text-md font-bold text-amber-500">
                      ...
                      return (
                        <div key={letterIndex} className="relative">
                          <input
                            ...
                            className={`w-4 h-6 text-center bg-transparent border-b-2 focus:outline-none ${feedback === 'correct'
        ...
        {showCombo && (
          <div className="absolute left-0 w-full flex justify-end pr-3 pointer-events-none" style={{ top:'30%' }}>
            <div
              className={`text-xl font-extrabold italic mt-2 mb-2 pr-2 transition-all duration-300 ${comboLevelUpClass} ${currentColor} `}
              style={textStyle}
            >
        ...
        >
          ...
          <div className="relative">
            <img
              ...
              className="w-16 h-16"
            />
            <TopoSpeechBubble text={currentSpeech} show={showSpeech} isMobile={true} />
          </div>
        </div>
      </div>
    </div>
